...
{
    public virtual async Task<SalesReportDto> GetSalesReportAsync(string fromUtc, string toUtc)
    ...
    public virtual async Task<List<TopProductReportDto>> GetTopProductsAsync(string fromUtc, string toUtc, int take = 20)
    ...
    public virtual async Task<List<CashFlowReportRowDto>> GetCashFlowAsync(string fromUtc, string toUtc, int take = 100)
    ...
    public virtual async Task<List<StockReportRowDto>> GetStockReportAsync(int take = 500)

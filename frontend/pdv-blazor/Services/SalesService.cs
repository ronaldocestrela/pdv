...
{
    public virtual async Task<CreateSaleResultDto> CreateSaleAsync(CreateSalePayload payload)
    {
    ...
    public virtual async Task<List<SaleListItemDto>> ListSalesAsync(int take = 50)
    {

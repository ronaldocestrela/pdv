...
{
    public async Task<List<ProductSummaryDto>> ListProductsAsync()
    {
        return await http.GetFromJsonAsync<List<ProductSummaryDto>>("/api/products") ?? [];
    }

    public async Task<ProductDetailDto?> GetProductAsync(string id)
    {
    ...
    public async Task<string> CreateProductAsync(string name, bool isActive)
    {
    ...
    public async Task UpdateProductAsync(string id, string name, bool isActive)
    {
    ...
    public async Task<string> CreateVariationAsync(string productId, string name, string? barcode, int stockQuantity, decimal unitPrice)
    {
    ...
    public async Task UpdateVariationAsync(string id, string name, string? barcode, int stockQuantity, decimal unitPrice)
    {

...
{
    public async Task AdjustStockAsync(string productVariationId, int quantity, string? reason)
    {
    ...
    public async Task<List<StockMovementDto>> ListMovementsAsync(string? variationId = null, int take = 100)
    {
